...
namespace CollegeProjectMVC.Controllers
{
    public class SoftwareEngineeringController : Controller
    {
        ...
        public ViewResult Modules()
        {
            ...
            SEModel.ModuleContents1 = "Website risk and vulnerability assesments.";
            ...
            SEModel.ModuleContents3 = "Data Minning for Data warehouse and marts.";
            ...
            SEModel.ModuleContents4 = "Data and analysis.";
            ...
            SEModel.ModuleContents5 = "Eathics and Law of privacy.";
            ...
            SEModel.ModuleContents6 = "Project developmet.";
